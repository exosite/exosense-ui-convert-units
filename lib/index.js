var convert
  ...
  , measures = {
    ...
    , temperatureDelta: require('./definitions/temperatureDelta')
    ...
    , dynamicViscosity : require('./definitions/dynamicViscosity')
    , kinematicViscosity : require('./definitions/kinematicViscosity')
    , flowMass : require('./definitions/flowMass')
    , conductivity : require('./definitions/conductivity')
    , concentrationMass : require('./definitions/concentration_mass')
  }
  , Converter;
